...
export const Route = createFileRoute('/privacidade')({
  head: () => ({
    meta: [
      { title: 'Política de Privacidade — Studio' },
      { name: 'description', content: 'Política de privacidade da plataforma Studio (LGPD).' },
    ],
  }),
...
function Privacidade() {
  return (
    <div className="mx-auto max-w-3xl px-5 py-12 text-sm leading-relaxed text-muted">
      ...
      <p className="mt-4">
        Esta política descreve como o Studio trata dados pessoais, em
