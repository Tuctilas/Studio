...
export const Route = createFileRoute('/termos')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Termos de uso da plataforma Studio.' },
    ],
  }),
  component: Termos,
})
...
function Termos() {
  return (
    <div className="prose prose-invert mx-auto max-w-3xl px-5 py-12 text-sm leading-relaxed text-muted [&_h1]:font-display [&_h1]:text-ink [&_h2]:font-display [&_h2]:text-ink">
      ...
      <p className="mt-4">
        Ao acessar o Studio, você declara ter <b>18 anos ou mais</b> e concorda
        com estes termos.
      </p>
      <h2 className="mt-8 text-xl">1. Natureza do serviço</h2>
      <p>
        O Studio é uma plataforma de <b>classificados de anúncios pessoais</b>{' '}
        publicados por anunciantes independentes, maiores de idade. O Studio
