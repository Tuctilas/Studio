    ...
    <header className="sticky top-0 z-50 border-b border-line bg-noir-950/90 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
        <Link to="/" className="flex items-baseline gap-0.5">
          <span className="font-display text-3xl font-semibold text-gold-400">S</span>
          <span className="font-display text-xl tracking-[0.18em] text-gold-400">TUDIO</span>
        </Link>
  ...
  return (
    <footer className="mt-16 border-t border-line py-10 text-sm text-muted">
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-5 sm:flex-row sm:items-center sm:justify-between">
        <div>
          © {new Date().getFullYear()} Studio · Anúncios +18 · Todas as
          anunciantes são maiores de 18 anos, com idade verificada.
        </div>
